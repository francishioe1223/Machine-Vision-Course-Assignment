...
def parse_opt(known=False):
    ...
    parser.add_argument("--weights", type=str, default=ROOT / "runs/train/exp27/weights/best.pt", help="initial weights path")
    parser.add_argument("--cfg", type=str, default="models/yolov5-asf.yaml", help="model.yaml path")
    parser.add_argument("--data", type=str, default=ROOT / "data/miniapple.yaml", help="dataset.yaml path")
